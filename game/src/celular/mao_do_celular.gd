## A mao do celular do jogo: copia da `MaoPosada` da abertura (ver o porque em
## `BracoDoCelular`). As pecas de baixo — palma, falanges, tenar, antebraco —
## continuam sendo as da `MaoModelada`, que e a mesma para o jogo inteiro.
##
