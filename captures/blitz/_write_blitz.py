...
blitz = r'''## Uma blitz montada na pista: funil de cones, viatura no acostamento,
...
path = Path(r"C:\Users\Administrator\Documents\Codes\Games\PSX\game\src\world\blitz.gd")
path.write_text(blitz, encoding="utf-8")
print("blitz.gd written", path.stat().st_size)
